...
class ChartingState extends MusicBeatState
{
	...
	[
		...
		['HUD Fade', 'Value 1 just for activating\n Value 2: tween speed'],
		['Cam lock', 'Value 1: "in" for in zoom\nValue 2: "dad" for dad'],
		['Aura mult', 'Change the scroll mult\nValue 2 turn multiplier on/off leave blank for off'],
		['DAD WINDOW', 'uh oh! Value 1: go (open new window)\n Value 1: close (closes window dumbass)'],
		['Renderproc cutscene', 'start = laser appear\n start2 = rendering process appear'],
		['Trans Zoom', 'val1: camzoom amount\n val2: no = zoom in and out with angle 10\n val2: yes = zoom in and out with default angle'],
