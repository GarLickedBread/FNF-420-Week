...
Under "switch(eventname) {", paste the following:
...
if(!ClientPrefs.flashing) { //depending on whether the player has flashing lights on
...
// END OF CUSTOM WEIRD SHADERS SHIT
