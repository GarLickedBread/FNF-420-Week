...
HXLINE(  76)		Float yScroll = ::Math_obj::max((((Float)0.25) - (((Float)0.05) * ( (Float)(this->optionShit->length) ))),((Float)0.1));
...
HXLINE(  85)		this->camFollow =  ::flixel::FlxObject_obj::__alloc( HX_CTX ,0,0,7,7);
HXLINE(  86)		this->camFollowPos =  ::flixel::FlxObject_obj::__alloc( HX_CTX ,0,0,7,7);
